"""
batch_prepare_hom.py
====================

Runs `prepare.py` for multiple GPT datasets based on artificial homonym corpora.

Assumes:
- Input JSONs are located in /home/nina/ambiguity/datasets/allkinds
- Each corpus has pre-split files:
    - {base}_{count}_HOM_train.json
    - {base}_{count}_HOM_val.json
    - {base}_{count}_HOM_test.json
- Output folders will be created inside
    /home/nina/ambiguity/gpt_pipelines/allkinds/data/
- Output naming follows: gpt_{base}_{count}_HOM

Usage:
------
python batch_prepare_hom.py
"""
...
print("\n🎉 All HOM datasets prepared successfully!")