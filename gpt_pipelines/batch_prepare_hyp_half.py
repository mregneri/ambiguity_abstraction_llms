"""
batch_prepare_hyp_half.py
=========================

Runs `prepare.py` for multiple GPT datasets based on 50% artificial hypernym corpora.

Assumes:
- Input JSONs are located in /home/nina/ambiguity/datasets/allkinds
- Each corpus has pre-split files:
    - {base}_{count}_HYP_HALF_train.json
    - {base}_{count}_HYP_HALF_val.json
    - {base}_{count}_HYP_HALF_test.json
- Output folders will be created inside:
    /home/nina/ambiguity/gpt_pipelines/allkinds/data
- Output naming follows: gpt_{base}_{count}_HYP_HALF

Usage:
------
python batch_prepare_hyp_half.py
"""
...
print("\n🎉 All HYP_HALF datasets prepared successfully!")