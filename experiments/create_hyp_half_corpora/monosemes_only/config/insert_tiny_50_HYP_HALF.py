...
config = {
    ...
    'train_out': '/home/nina/ambiguity/datasets/tiny_50_HYP_HALF_train.json',
    'val_out': '/home/nina/ambiguity/datasets/tiny_50_HYP_HALF_val.json',
    'test_out': '/home/nina/ambiguity/datasets/tiny_50_HYP_HALF_test.json',
    ...
    'summary_log': '/home/nina/ambiguity/experiments/create_hyp_half_corpora/logs/tiny_50_HYP_HALF_summary.txt'
}
