...
config = {
    ...
    'train_out': '/home/nina/ambiguity/datasets/tiny_20_HOM_HALF_train.json',
    'val_out': '/home/nina/ambiguity/datasets/tiny_20_HOM_HALF_val.json',
    'test_out': '/home/nina/ambiguity/datasets/tiny_20_HOM_HALF_test.json',
    ...
    'summary_log': '/home/nina/ambiguity/experiments/create_hom_half_corpora/logs/tiny_20_HOM_HALF_summary.txt'
}
