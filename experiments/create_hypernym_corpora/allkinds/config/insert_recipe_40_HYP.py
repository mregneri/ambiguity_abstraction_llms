# config/insert_recipe_40_HYP.py
config = {
    ...
    'train_out': '/home/nina/ambiguity/datasets/allkinds/recipe_40_HYP_train.json',
    'val_out': '/home/nina/ambiguity/datasets/allkinds/recipe_40_HYP_val.json',
    'test_out': '/home/nina/ambiguity/datasets/allkinds/recipe_40_HYP_test.json',
    ...
    'summary_log': '/home/nina/ambiguity/experiments/create_hypernym_corpora/allkinds/logs/recipe_40_HYP_summary.txt'
}
