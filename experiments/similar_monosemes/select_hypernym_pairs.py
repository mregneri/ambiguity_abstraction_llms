"""
select_hypernym_pairs.py
==============================

This script selects a set of most similar monoseme pairs from CSV files created by
`monoseme_hypernym_analysis.py`, ensuring that each monoseme appears in only one pair.

These pairs are intended for the creation of artificial hypernyms.
...
Usage:
------
$ python select_hypernym_pairs.py
...
PAIR_FILES = [
    {
        'name': 'TinyStories',
        'input_csv': 'tiny_base_similar_pairs.csv',
        'output_csv': 'hypernym_pairs_tiny.csv'
    },
    {
        'name': 'RecipeNLG',
        'input_csv': 'recipe_base_similar_pairs.csv',
        'output_csv': 'hypernym_pairs_recipe.csv'
    }
]
